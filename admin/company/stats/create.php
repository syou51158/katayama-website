...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        $result = SupabaseClient::insert('company_stats', [
            'stat_name' => $stat_name,
        ...
        <form action="" method="post">
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="stat_name" name="stat_name" 
                       value="<?php echo htmlspecialchars($stat_name ?? ''); ?>" placeholder="例：創業" required>
            </div>
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control" id="stat_value" name="stat_value" 
                           value="<?php echo htmlspecialchars($stat_value ?? ''); ?>" placeholder="例：50" required>
                </div>
                <div class="col-md-6 mb-3">
                    <label for="stat_unit" class="form-label">単位</label>
                    <input type="text" class="form-control" id="stat_unit" name="stat_unit" 
                           value="<?php echo htmlspecialchars($stat_unit ?? ''); ?>" placeholder="例：年">
                </div>
            </div>
