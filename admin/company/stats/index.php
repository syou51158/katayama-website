...
// Fetch stats
$stats = SupabaseClient::select('company_stats', [], [
                ...
                <tbody>
                    <?php if ($stats && is_array($stats) && count($stats) > 0): ?>
                        ...
                        <tr>
                            ...
                            <td class="fw-bold">
                                <?php echo htmlspecialchars($row['stat_name']); ?>
                            </td>
                            <td>
                                <?php echo htmlspecialchars($row['stat_value']); ?>
                            </td>
                            <td>
                                <?php echo htmlspecialchars($row['stat_unit']); ?>
                            </td>
