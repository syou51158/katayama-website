...
$reps = SupabaseClient::select('representatives', [], [
    ...
    <div class="card-body p-0">
        <div class="table-responsive">
            <table class="table table-hover align-middle mb-0">
                ...
                <tbody>
                    <?php if ($reps && is_array($reps) && count($reps) > 0): ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php if (!empty($row['photo_url'])): ?>
                                    <img src="<?php echo htmlspecialchars($row['photo_url']); ?>" class="rounded-circle" style="width: 40px; height: 40px; object-fit: cover;">
                                <?php else: ?>
