...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <div class="d-flex align-items-center">
        <i class="bi bi-bricks fs-4 me-2 text-primary"></i>
        <h1 class="h2 mb-0">施工実績管理</h1>
    </div>
    ...
    <div class="card-body p-0">
        <div class="table-responsive">
            <table class="table table-hover align-middle mb-0">
                ...
                <tbody>
                    <?php if ($works && is_array($works) && count($works) > 0): ?>
                        <?php foreach ($works as $row): ?>
                        <tr>
                            <td class="ps-4">
                                <?php if (!empty($row['featured_image'])): ?>
                                    <img src="<?php echo htmlspecialchars($row['featured_image']); ?>" class="rounded" style="width: 60px; height: 40px; object-fit: cover;">
                                <?php else: ?>
                                    <div class="bg-light rounded d-flex align-items-center justify-content-center text-muted" style="width: 60px; height: 40px; font-size: 0.75rem;">
                                        No Image
                                    </div>
                                <?php endif; ?>
                            </td>
                            ...
                            <td>
                                <?php echo !empty($row['completion_date']) ? date('Y-m', strtotime($row['completion_date'])) : '-'; ?>
                            </td>
                            <td>
                            ...
                            <td class="text-end pe-4">
                                ...
                                <form action="delete.php" method="post" style="display:inline" onsubmit="return confirm('本当にこの実績を削除しますか？');">
